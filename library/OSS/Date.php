...
class OSS_Date
{
    public const DF_EUROPEAN = 1;
    public const DF_AMERICAN = 2;
    public const DF_COMPUTER = 3;
    public const DF_REVERSE  = 4;
    public const DF_COMPACT  = 5;
