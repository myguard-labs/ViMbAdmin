...
class QueueController extends ViMbAdmin_Controller_Action
{
    ...
    // =====================================================================
    //  Enqueue helper (called by other controllers)
    // =====================================================================

    /**
     * Queue a task for a mailbox. Idempotent-ish: refuses to stack a second
     * open (PENDING/RUNNING) task of the same type for the same username.
     *
